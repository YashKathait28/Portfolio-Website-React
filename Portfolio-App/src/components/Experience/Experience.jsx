           ...
           <div className="flex flex-wrap items-center justify-around">
            ...
            <div className="flex gap-10 bg-slate-950 bg-opacity-45 mt-4 rounded-lg p-4 items-center">
                ...
                <span className="text-white">
                    <h2 className="leading-tight">Software Engineering, Google</h2>
            ...
            <div className="flex gap-10 bg-slate-950 bg-opacity-45 mt-4 rounded-lg p-4 items-center">
                ...
                <span className="text-white">
                    <h2 className="leading-tight">Software Engineering, Netflix</h2>
                    <p className="text-sm leading-tight font-thin">Sept 2023 - Present</p>
                    <ul className="text-sm p-2">
                        <li>- Work as Software Developer</li>
                        <li>- Sinior SDE Developer</li>
            ...
            <div className="flex gap-10 bg-slate-950 bg-opacity-45 mt-4 rounded-lg p-4 items-center">
                ...
                <span className="text-white">
                    <h2 className="leading-tight">Software Engineering, Amazon</h2>
                    <p className="text-sm leading-tight font-thin">Sept 2023 - Present</p>
                    <ul className="text-sm p-2">
                        <li>- Work as Software Developer</li>
                        <li>- Sinior SDE Developer</li>
